...
source $TOOL_NAME_PATH/.env/bin/activate
app_name=$1
stoat_path=$2
state=$3
RESULT_DIR="$TOOL_NAME_PATH/stoat_results"
...
python $TOOL_NAME_PATH/py_src/main.py --app-name "$app_name" --output-path "$RESULT_DIR"  --app-task "stoat_save_snapshot" --emulator  --debug
