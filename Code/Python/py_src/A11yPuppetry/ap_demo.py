...
async def main(result_path: Union[str, Path], controllers: List[str], ws_ip: str, ws_port: int,
    ...
    app_paths = [f"$TOOL_NAME_PATH/Setup/TOOL_NAME.apk"]
    ...
    if online_replay:
        ...
        if recorder_instance is None:
            ...
            if await install_application(apk_path="$TOOL_NAME_PATH/Setup/Sugilite.apk", device_name=recorder_instance.get_adb_device_name()):
